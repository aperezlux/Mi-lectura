...
// Which day types correspond to morning masses
export const MORNING_DAY_TYPES: DayType[] = ["weekday", "thursday_am", "saturday_am", "sunday_am"];
// Which day types correspond to evening masses
export const EVENING_DAY_TYPES: DayType[] = ["thursday_pm", "saturday_pm", "sunday_pm"];
...
export const DEFAULT_SCHEDULES: Array<{
  ...
  { name: "Misa Jueves Mañana",           dayType: "thursday_am", time: "06:00", isActive: true, sortOrder: 2 },
  { name: "Misa Jueves Solemne/Hora Santa", dayType: "thursday_pm", time: "19:00", isActive: true, sortOrder: 3 },
  { name: "Misa Sábado A.M.",             dayType: "saturday_am", time: "07:00", isActive: true, sortOrder: 4 },
  { name: "Misa Sábado P.M.",             dayType: "saturday_pm", time: "18:00", isActive: true, sortOrder: 5 },
  { name: "Misa Domingo A.M.",            dayType: "sunday_am",   time: "08:00", isActive: true, sortOrder: 6 },
  { name: "Misa Domingo P.M.",            dayType: "sunday_pm",   time: "18:00", isActive: true, sortOrder: 7 },
];
